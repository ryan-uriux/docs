...
<CardGroup cols="2">
  ...
  <Card title="Panels" icon="users" iconType="regular" href="/clients/panels/introduction.mdx">
    Build curated lists of panelists specific to your needs that you can invite to your studies or send targeted surveys to.
  </Card>
</CardGroup>
