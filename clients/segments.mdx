...
**Flexible logic:** Use AND/OR conditions to combine multiple attributes for highly specific targeting.
**Reusable across workflows:** Segments can used when sending surveys to target audiences or sourcing candidates into a study.