...
To create your first panel, simply navigate to the Panels page and click on the `+ Create Panel` button.  Give your panel a name and description and voila\!  You're done\!  But of course a panel isn't useful without any panelists in it, so let's add some folks to our panel.
