...
## Step 2: Configure Embedded Data in Qualtrics (Optional)

This step is only necessary if you want Qualtrics to capture the URL parameters that Panel Pro sends (respondent ID, panelist ID, labels). If you just need to redirect respondents to a Qualtrics survey without passing data, skip to [Step 3](#step-3-add-a-redirect-block-in-panel-pro).
